...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.af_coarse = QtWidgets.QDoubleSpinBox(); self.af_coarse.setRange(0.001, 1.0); self.af_coarse.setValue(0.01)
        self.af_fine = QtWidgets.QDoubleSpinBox(); self.af_fine.setRange(0.0005, 0.2); self.af_fine.setValue(0.002)
