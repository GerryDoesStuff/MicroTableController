...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.stepx_spin = QtWidgets.QDoubleSpinBox(); self.stepx_spin.setDecimals(6); self.stepx_spin.setRange(0.001, 1000.0); self.stepx_spin.setValue(0.100)
        self.stepy_spin = QtWidgets.QDoubleSpinBox(); self.stepy_spin.setDecimals(6); self.stepy_spin.setRange(0.001, 1000.0); self.stepy_spin.setValue(0.100)
        self.stepz_spin = QtWidgets.QDoubleSpinBox(); self.stepz_spin.setDecimals(6); self.stepz_spin.setRange(0.001, 1000.0); self.stepz_spin.setValue(0.100)
        ...
        self.af_coarse = QtWidgets.QDoubleSpinBox(); self.af_coarse.setDecimals(6); self.af_coarse.setRange(0.001, 1.0); self.af_coarse.setValue(0.01)
        ...
        self.stack_step = QtWidgets.QDoubleSpinBox(); self.stack_step.setDecimals(6); self.stack_step.setRange(0.001, 1.0); self.stack_step.setValue(0.01)
